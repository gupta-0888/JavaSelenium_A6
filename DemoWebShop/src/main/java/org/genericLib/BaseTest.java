...
public class BaseTest implements FrameworkConstants{
	...
	public void browserSetUp() {
		String browser = Flib.getPropertyValue(propPath,"chrome");
	...
	@BeforeMethod
	public void login() {
		String email = Flib.getPropertyValue(propPath, "email");
		String password = Flib.getPropertyValue(propPath, "password");
